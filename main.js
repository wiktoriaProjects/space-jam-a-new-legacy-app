...
function updateCardsInGame() {
    ...
    for(var playerIndex = 0; playerIndex < currentPlayers.length; playerIndex++){
        ...
        var playerPER = playerMap.get(playerMap)[currentQuarter];
...
function endQuarter() {
    ...
    document.getElementById('start').innerText = 'Choose Players for Q' + (currentQuarter + 1);
...
function endGame() {
    ...
    alert('Game over. Game Avg PER was: ' + averagePER.toPrecision(4));
